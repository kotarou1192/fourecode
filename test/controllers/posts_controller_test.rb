...
class PostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'post should be created' do
    ...
    reward = 200
    post '/api/v1/posts', params: { token: { onetime: o.token }, value: { body: body, code: code, source_url: source_url, bestanswer_reward: reward } }
  ...
  test 'post with empty token should be failed' do
    ...
    source_url = 'https://github.com/kotarou1192/fourecode'
    reward = 200
    post '/api/v1/posts', params: { value: { body: body, code: code, source_url: source_url, bestanswer_reward: reward } }
